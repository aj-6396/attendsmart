    ...
    <div className="w-full max-w-md sm:max-w-lg flex flex-col gap-3 sm:gap-4 mx-auto">
      ...
      >
        ...
        <div className="mb-5 sm:mb-6">
          ...
          <p className="text-[--color-text-secondary] text-xs sm:text-sm mt-1">Teacher & Faculty Portal</p>
        </div>
        ...
        <form onSubmit={onLogin} className="space-y-4">
          <div className="field-group">
            ...
            <p className="text-xs text-[--color-text-secondary] mt-1">
              Your registered institutional email address
            </p>
          </div>
          ...
          <div className="field-group">
            ...
            <div className="text-right mt-1.5">
              <button
                ...
                className="text-xs text-rose-600 dark:text-rose-400 hover:underline font-semibold py-1 inline-block"
              >
                Forgot password?
              </button>
            </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="btn-gradient mt-4 w-full bg-[#800000] hover:bg-[#600000] dark:bg-rose-600 dark:hover:bg-rose-700"
          >
            {loading ? <Loader2 className="w-4 h-4 animate-spin mx-auto" /> : 'Sign In as Teacher'}
          </button>
        </form>
        ...
        {/* Admin Contact Info */}
        <div className="p-3 bg-slate-50 dark:bg-slate-800/60 rounded-xl text-center border border-slate-200 dark:border-slate-700/60">
