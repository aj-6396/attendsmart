...
import { LogIn, LogOut, AlertCircle, CheckCircle2, Loader2, ArrowLeft, Eye, EyeOff, ShieldCheck } from 'lucide-react';
        ...
        >
          ...
          <div className="relative">
            ...
            <button
              ...
              className="absolute right-3 top-1/2 -translate-y-1/2 text-[--color-text-secondary] hover:text-[--color-primary] transition-colors p-1"
            >
